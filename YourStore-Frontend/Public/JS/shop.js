...
$(document).ready(function() {
    ...
    const get_profile_url = 'http://localhost:5000/stores/myStore';
    ...
    const add_products_api = "http://localhost:5000/myStore/addItem";
    ...
    const get_products = 'http://localhost:5000/myProducts';
    ...
    function getRequests() {
        const get_requests_api = "http://localhost:5000/store/requested";
    ...
    function getOrders() {
        const get_orders_api = "http://localhost:5000/store/Orders";
    ...
    function getOrderHistory() {
        const get_orders_api = "http://localhost:5000/store/OrderHistory";
    ...
    $("body").on("click", ".deliver-btn", function(e) {
        ...
        $(".confirm-delivery").on("click", function(e) {
            ...
            let delivery_api = `http://localhost:5000/store/delivered/${userID}/${orderID}`;
    ...
    $(".products").on('click', '.delete-item-btn' ,function(e) {
        ...
        const delete_item_url = `http://localhost:5000/myProducts/delete/${id}`;
    ...
    $("body").on("click", ".delete-request", function(e) {
        ...
        $(".confirm-request-delete").on("click", function(e) {
            ...
            const delete_request_api = `http://localhost:5000/requests/remove/${requestID}`;
            let myHeaders = new Headers();
            myHeaders.append("Authorization", `Bearer ${localStorage.getItem('shopAuth')}`);
    ...
    $(".logout").on('click', function(e) {
        ...
        const logout_api = 'http://localhost:5000/store/logout';

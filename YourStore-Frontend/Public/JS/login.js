$(document).ready(function () {
  ...
  const signup_url = "http://localhost:5000/user/signup";
  const shop_signup_url = "http://localhost:5000/store/register";
  const shop_signin_url = "http://localhost:5000/store/login";

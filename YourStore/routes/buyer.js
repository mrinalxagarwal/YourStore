  ...
  try { 
    ...
    jwt.sign(
      ...
      (err, emailToken) => {
        ...
        //it uses sendgrid
        url = `http://localhost:5000/user/confirmation/${emailToken}`;

        let apiInstance = new SibApiV3Sdk.TransactionalEmailsApi();

        let sendSmtpEmail = new SibApiV3Sdk.SendSmtpEmail();

        sendSmtpEmail.subject = "Verify your email for ApnaBazaar";
        sendSmtpEmail.htmlContent = `<html><body><h1>Verify your email to continue using ApnaBazaar!</h1><a href='${url}'>Verify here</a></body></html>`;
        sendSmtpEmail.sender = {"name":"ApnaBazaar","email":"shashanksuresh3@gmail.com"};
        sendSmtpEmail.to = [{"email":newUser.email,"name":newUser.name}];
        sendSmtpEmail.replyTo = {"email":"shashanksuresh3@gmail.com","name":"ApnaBazaar"};
        sendSmtpEmail.headers = {"Oh-My-God":"yomamagayfrfr"};
        sendSmtpEmail.params = {"parameter":"Yuh...","subject":"Verify your email NOW"};

        // sendSmtpEmail.subject = '';
        // sendSmtpEmail.sender = {
        //   name: 'YourStore',
        //   email: 'shashanksuresh3@gmail.com',
        // };
        ...
        //   parameter: 'yuh...',
        //   subject: 'Verify email for ApnaBazaar',
        //   verify_link: url,
